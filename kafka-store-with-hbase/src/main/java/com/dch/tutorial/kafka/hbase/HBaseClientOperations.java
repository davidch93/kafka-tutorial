...
public class HBaseClientOperations {
	 ...
	 * @throws IOException
	 *             Error occurred when check existing table in HBase.
	 */
	 ...
	 *            Basic HBase client operation.
	 * @throws IOException
	 *             If error occurred when HBase client failed to initialize table.
	 */
	 ...
	 * @return List of user.
	 * @throws IOException
	 *             Error occurred when scanning data in HBase table.
	 */
	 ...
	 * 
	 * @param tableName
	 *            {@link TableName} Table name to delete.
	 * @throws IOException
	 */
